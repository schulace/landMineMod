...
import com.schulace.landminemod.blocks.FacingBlock;
...
public class LandMineModBlocks
{
	...
	public static void initBlocks()
	{
		...
		facing_block = new FacingBlock("facing_block");
	...
	public static void registerBlocks()
	{
		...
		GameRegistry.registerBlock(facing_block, facing_block.getUnlocalizedName().substring(5));
	}
